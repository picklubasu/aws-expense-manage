...
package_deploy() {
	...
	sam deploy --template-file ${CODEBUILD_SRC_DIR}/template.json --stack-name "345814638087-ap-south-1-aws-expense-manage-build-cloudwatch-alarm" --parameter-overrides $SAM_PARAMETERS
}
